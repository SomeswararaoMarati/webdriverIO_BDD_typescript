...
const currentDate = `${paddedYear}${paddedMonth}${paddedDate}`;
...
export const config: WebdriverIO.Config = {
  ...
  cucumberOpts: {
    ...
    // Specify the path to save the generated snippets
    format: ['pretty', `html:./reports/cucumber-report_${currentDate}_${currentTimestamp}.html`], // Generate HTML report
